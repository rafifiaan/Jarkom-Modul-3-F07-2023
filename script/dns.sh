...
zone "4.55.10.in-addr.arpa" {
    type master;
    file "/etc/bind/jarkom/4.55.10.in-addr.arpa";
};
...
zone "3.55.10.in-addr.arpa" {
    type master;
    file "/etc/bind/jarkom/3.55.10.in-addr.arpa";
};
...
@       IN      SOA     riegel.canyon.f07.com. root.riegel.canyon.f07.com. (
                        ...
                        604800 )      ; Negative Cache TTL
;
4.55.10.in-addr.arpa.         	IN      NS      riegel.canyon.f07.com.
1                               IN      PTR     riegel.canyon.f07.com.
' > /etc/bind/jarkom/4.55.10.in-addr.arpa



# Isi dari /etc/bind/jarkom/3.55.10.in-addr.arpa
echo '
; BIND data file for local loopback interface
;
$TTL    604800
@       IN      SOA     granz.channel.f07.com. root.granz.channel.f07.com. (
                        ...
                        604800 )      ; Negative Cache TTL
;
3.55.10.in-addr.arpa.         	IN      NS      granz.channel.f07.com.
1                               IN      PTR     granz.channel.f07.com.
' > /etc/bind/jarkom/3.55.10.in-addr.arpa
